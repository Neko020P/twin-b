...
set_target_properties(energyplus::energyplusapi PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./libenergyplusapi.so.25.1.0"
  IMPORTED_SONAME_RELEASE "libenergyplusapi.so.25.1.0"
  )

list(APPEND _cmake_import_check_targets energyplus::energyplusapi )
list(APPEND _cmake_import_check_files_for_energyplus::energyplusapi "${_IMPORT_PREFIX}/./libenergyplusapi.so.25.1.0" )
...
set_target_properties(energyplus::energyplus PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/./energyplus-25.1.0"
  )

list(APPEND _cmake_import_check_targets energyplus::energyplus )
list(APPEND _cmake_import_check_files_for_energyplus::energyplus "${_IMPORT_PREFIX}/./energyplus-25.1.0" )
