...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASECPPFLAGS': '',
 'BASEMODLIBS': '',
 'BINDIR': '/root/.pyenv/versions/3.12.2/bin',
 'BINLIBDEST': '/root/.pyenv/versions/3.12.2/lib/python3.12',
 'BLDLIBRARY': '-L. -lpython3.12',
 'BLDSHARED': '/opt/rh/devtoolset-10/root/usr/bin/gcc -pthread -shared '
              '-L/root/.pyenv/versions/3.12.2/lib '
              '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
 ...
 'CONFIGURE_CFLAGS_NODIST': '-std=c11 -Wextra -Wno-unused-parameter '
                            ...
                            '-fvisibility=hidden',
 'CONFIGURE_CPPFLAGS': '-I/root/.pyenv/versions/3.12.2/include '
                       '-I/usr/include/openssl11',
 'CONFIGURE_LDFLAGS': '-L/root/.pyenv/versions/3.12.2/lib '
                      '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
                      '-L/usr/lib64/openssl11 -lssl -lcrypto',
 'CONFIGURE_LDFLAGS_NODIST': '',
 'CONFIGURE_LDFLAGS_NOLTO': '',
 'CONFIG_ARGS': "'--prefix=/root/.pyenv/versions/3.12.2' "
                "'--libdir=/root/.pyenv/versions/3.12.2/lib' '--enable-shared' "
                "'CC=/opt/rh/devtoolset-10/root/usr/bin/gcc' "
                "'LDFLAGS=-L/root/.pyenv/versions/3.12.2/lib "
                '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
                "-L/usr/lib64/openssl11 -lssl -lcrypto  ' "
                "'LIBS=-L/root/.pyenv/versions/3.12.2/lib "
                "-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib' "
                "'CPPFLAGS=-I/root/.pyenv/versions/3.12.2/include "
                "-I/usr/include/openssl11  '",
 'CONFINCLUDEDIR': '/root/.pyenv/versions/3.12.2/include',
 'CONFINCLUDEPY': '/root/.pyenv/versions/3.12.2/include/python3.12',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/tmp/python-build.20240910132524.189/Python-3.12.2/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/tmp/python-build.20240910132524.189/Python-3.12.2/lcov-report',
 'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage '
                            '--title "CPython 3.12 LCOV report [commit $(shell '
                            ')]"',
 'CPPFLAGS': '-I. -I./Include -I/root/.pyenv/versions/3.12.2/include '
             '-I/usr/include/openssl11 -I/root/.pyenv/versions/3.12.2/include '
             '-I/usr/include/openssl11',
 ...
 'DESTDIRS': '/root/.pyenv/versions/3.12.2 /root/.pyenv/versions/3.12.2/lib '
             '/root/.pyenv/versions/3.12.2/lib/python3.12 '
             '/root/.pyenv/versions/3.12.2/lib/python3.12/lib-dynload',
 'DESTLIB': '/root/.pyenv/versions/3.12.2/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/root/.pyenv/versions/3.12.2/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '',
 'EXEMODE': 755,
 'EXENAME': '/root/.pyenv/versions/3.12.2/bin/python3.12',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 ...
 'INCLDIRSTOMAKE': '/root/.pyenv/versions/3.12.2/include '
                   '/root/.pyenv/versions/3.12.2/include '
                   '/root/.pyenv/versions/3.12.2/include/python3.12 '
                   '/root/.pyenv/versions/3.12.2/include/python3.12',
 'INCLUDEDIR': '/root/.pyenv/versions/3.12.2/include',
 'INCLUDEPY': '/root/.pyenv/versions/3.12.2/include/python3.12',
 ...
 'LDVERSION': '3.12',
 'LIBC': '',
 'LIBDEST': '/root/.pyenv/versions/3.12.2/lib/python3.12',
 'LIBDIR': '/root/.pyenv/versions/3.12.2/lib',
 ...
 'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare '
                    ...
                    '-I/root/.pyenv/versions/3.12.2/include '
                    '-I/usr/include/openssl11 '
                    '-I/root/.pyenv/versions/3.12.2/include '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/root/.pyenv/versions/3.12.2/lib/pkgconfig',
 'LIBPL': '/root/.pyenv/versions/3.12.2/lib/python3.12/config-3.12-x86_64-linux-gnu',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.12.a',
 'LIBRARY_DEPS': 'libpython3.12.a libpython3.12.so libpython3.so',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-lpthread -ldl -L/root/.pyenv/versions/3.12.2/lib '
         '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib -lutil',
 'LIBSUBDIRS': 'asyncio \\',
 ...
 'MACHDEP': 'linux',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/root/.pyenv/versions/3.12.2/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 1,
 'MAKESETUP': './Modules/makesetup',
 'MANDIR': '/root/.pyenv/versions/3.12.2/share/man',
 ...
 'PY_CORE_LDFLAGS': '-L/root/.pyenv/versions/3.12.2/lib '
                    '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
                    '-L/usr/lib64/openssl11 -lssl -lcrypto '
                    '-L/root/.pyenv/versions/3.12.2/lib '
                    '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
                    '-L/usr/lib64/openssl11 -lssl -lcrypto',
 'PY_CPPFLAGS': '-I. -I./Include -I/root/.pyenv/versions/3.12.2/include '
                '-I/usr/include/openssl11 '
                '-I/root/.pyenv/versions/3.12.2/include '
                '-I/usr/include/openssl11',
 'PY_ENABLE_SHARED': 1,
 'PY_HAVE_PERF_TRAMPOLINE': 1,
 'PY_LDFLAGS': '-L/root/.pyenv/versions/3.12.2/lib '
               '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
               '-L/usr/lib64/openssl11 -lssl -lcrypto '
               '-L/root/.pyenv/versions/3.12.2/lib '
               '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
               '-L/usr/lib64/openssl11 -lssl -lcrypto',
 'PY_LDFLAGS_NODIST': '',
 'PY_LDFLAGS_NOLTO': '-L/root/.pyenv/versions/3.12.2/lib '
                     '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
                     '-L/usr/lib64/openssl11 -lssl -lcrypto '
                     '-L/root/.pyenv/versions/3.12.2/lib '
                     '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib '
 ...
 'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -DNDEBUG -g -O3 '
                        ...
                        '-Werror=implicit-function-declaration '
                        '-fvisibility=hidden  -I./Include/internal -I. '
                        '-I./Include -I/root/.pyenv/versions/3.12.2/include '
                        '-I/usr/include/openssl11 '
                        '-I/root/.pyenv/versions/3.12.2/include '
                        '-I/usr/include/openssl11 -fPIC',
 'PY_SUPPORT_TIER': 1,
 ...
 'RETSIGTYPE': 'void',
 'RUNSHARED': 'LD_LIBRARY_PATH=/tmp/python-build.20240910132524.189/Python-3.12.2',
 'SCRIPTDIR': '/root/.pyenv/versions/3.12.2/lib',
 ...
 'SHELL': '/bin/sh -e',
 'SHLIBS': '-lpthread -ldl -L/root/.pyenv/versions/3.12.2/lib '
           '-Wl,-rpath,/root/.pyenv/versions/3.12.2/lib -lutil',
 'SHLIB_SUFFIX': '.so',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': 'LD_LIBRARY_PATH=/tmp/python-build.20240910132524.189/Python-3.12.2 '
               './python -E',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': 'LD_LIBRARY_PATH=/tmp/python-build.20240910132524.189/Python-3.12.2 '
 ...
 'VERSION': '3.12',
 'WASM_ASSETS_DIR': './root/.pyenv/versions/3.12.2',
 'WASM_STDLIB': './root/.pyenv/versions/3.12.2/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
 ...
 'abs_builddir': '/tmp/python-build.20240910132524.189/Python-3.12.2',
 'abs_srcdir': '/tmp/python-build.20240910132524.189/Python-3.12.2',
 'datarootdir': '/root/.pyenv/versions/3.12.2/share',
 'exec_prefix': '/root/.pyenv/versions/3.12.2',
 'prefix': '/root/.pyenv/versions/3.12.2',
 'srcdir': '.'}
